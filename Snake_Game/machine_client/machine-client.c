...
{	 
    ...
    init_remote_char_msg(&message, -1, 1, ch, number_cr, UP, -5);
    ...
    for(int n=0; 1; n++)
    {
        ...
        for(int i=0; i<number_cr;i++){
            ...
            if (received_termination_signal) {
                ...
                init_remote_char_msg(&message, -1, 7, ids, number_cr, UP, key);
            ...
            init_remote_char_msg(&message, ids[i], 3, ch, number_cr, direction, key); // initializes movement cr_m
